...
/*   Updated: 2024/05/14 21:23:58 by kchan            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout<< "[DEBUG]: Syntax issue" << std::endl;
}
void Harl::info(void)
{
	std::cout<< "[INFO]: It contains space and alphabets" << std::endl;
}
void Harl::warning(void)
{
	std::cout<<"[WARNING]: Some softwares maynot be able to parse variable name with space correctly" << std::endl;
}
void Harl::error(void)
{
	std::cout<<"[ERROR]: Space is not accecpted for this program " << std::endl;
}
